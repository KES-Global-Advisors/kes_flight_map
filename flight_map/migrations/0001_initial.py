# Generated by Django 5.1.4 on 2025-06-12 15:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('draft_id', models.IntegerField(blank=True, help_text='ID of the draft this was created from', null=True)),
                ('completed_at', models.DateTimeField(blank=True, help_text='When the flightmap was completed', null=True)),
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='owned_flightmaps', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['-created_at'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source_milestone', models.ForeignKey(help_text='The milestone where this activity originates', on_delete=django.db.models.deletion.CASCADE, related_name='source_activities', to='flight_map.milestone')),
                ...
                ('target_milestone', models.ForeignKey(help_text='The milestone this activity connects to within the same workstream', on_delete=django.db.models.deletion.CASCADE, related_name='target_activities', to='flight_map.milestone')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('node_type', models.CharField(choices=[('workstream', 'Workstream'), ('milestone', 'Milestone')], max_length=12)),
                ('node_id', models.CharField(max_length=100)),
                ('rel_y', models.FloatField()),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('is_duplicate', models.BooleanField(default=False)),
                ('duplicate_key', models.CharField(blank=True, max_length=100, null=True)),
                ('original_node_id', models.IntegerField(blank=True, null=True)),
                ('flightmap', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='positions', to='flight_map.flightmap')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('flightmap', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='strategies', to='flight_map.flightmap')),
        ...
        migrations.AddField(
            ...
            name='strategy',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='goals', to='flight_map.strategy'),
        ),
        migrations.CreateModel(
            name='Program',
            fields=[
        ...
        migrations.AddField(
            ...
            name='workstream',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='milestones', to='flight_map.workstream'),
        ),
        migrations.CreateModel(
